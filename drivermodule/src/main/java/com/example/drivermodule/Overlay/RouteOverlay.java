...
public class RouteOverlay {
    ...
    protected BitmapDescriptor getEndBitmapDescriptor() {
        return BitmapDescriptorFactory.fromResource(R.drawable.select_point);
    }
    ...
    protected void addStartAndEndMarker() {
        startMarker = mAMap.addMarker((new MarkerOptions()).zIndex(2f)
                .anchor(0.5f, 0.5f).position(startPoint).icon(BitmapDescriptorFactory.fromResource(R.drawable.myself_all)));
