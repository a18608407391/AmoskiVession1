...
//            Log.e("result","是空的")
//        }
//        mapActivity = parentFragment as MapFragment
//        if(mapActivity==null){
//            Log.e("result","parentFragment")
//        }
//        mapActivity.showProgressDialog(getString(R.string.location_loading))
//        initResume()
    }

    fun resumeDriver(mapActivity: MapFragment) {
...
//            viewModel?.startDrive(false)
            ...
            CoroutineScope(uiContext).async {
                delay(200)
                mapActivity.viewModel?.selectTab(2)
                mapActivity.viewModel?.changerFragment(3)
                if (PreferenceUtils.getString(mapActivity.activity, PreferenceUtils.getString(context, USERID) + "hot") == null && mapActivity.hotData == null) {
