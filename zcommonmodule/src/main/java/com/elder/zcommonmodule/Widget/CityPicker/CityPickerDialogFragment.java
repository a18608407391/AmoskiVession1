package com.elder.zcommonmodule.Widget.CityPicker;
...
import com.elder.zcommonmodule.Widget.CityPicker.adapter.CityListAdapter;
import com.elder.zcommonmodule.Widget.CityPicker.adapter.InnerListener;
import com.elder.zcommonmodule.Widget.CityPicker.adapter.OnPickListener;
import com.elder.zcommonmodule.Widget.CityPicker.adapter.decoration.DividerItemDecoration;
import com.elder.zcommonmodule.Widget.CityPicker.adapter.decoration.SectionItemDecoration;
import com.elder.zcommonmodule.Widget.CityPicker.db.DBManager;
...
import com.elder.zcommonmodule.Widget.CityPicker.view.SideIndexBar;
...
//        mAllCities.add(1, new HotCity("行政区", "未知", "0"));
        mResults = mAllCities;
    }
