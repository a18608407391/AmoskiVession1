...
class RouterUtils() {
    ...
    class MapModuleConfig {
        companion object {
            ...
            const val NAVIGATION_START = "/map/navigation_start"
            const val NAVIGATION_End = "/map/navigation_end"
            ...
            const val RESUME_MAP_TEAMCODE = "/map/map_teamcode"
